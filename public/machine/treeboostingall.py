...
try:
    ...
    # neighbors
    sql_select_query_model3 = '''SELECT name from models WHERE type = 'neighbors' ORDER BY id desc limit 1'''
    ...
    loaded_model3 = joblib.load(mode3)  # neighbors
    ...
    hasil2 = pd.DataFrame(result2)  # randomforest
    hasil3 = pd.DataFrame(result3)  # neighbors
    nip = readfile['NIP']
    name = readfile['NAMA']
