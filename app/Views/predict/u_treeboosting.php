        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-content">
                    ...
                    <p>unggah berkas yang akan diprediksi menggunakan Algoritma Gradient Tree Boosting dengan file save model <i><?= models('treeboosting')->name ?></i>.</p>
                    <div class="custom-file mt-2">
                        ...
                        <form method="post" action="<?= base_url('treeboosting/create'); ?>" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="prediksi2" id="inlineCheckbox2" value="neighbors">
                                    <label class="form-check-label" for="inlineCheckbox2">K-Neighbors</label>
                                </div>
                            </div>
